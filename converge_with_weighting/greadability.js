...
var greadability = function (nodes, links, id) {
  ...
  */
  ...
  // when calculating your metrics
  var crossings = linkCrossings();
  graphStats.crossing = crossings.c * weights.crossing;
  graphStats.crossingAngle = crossings.d * weights.crossingAngle;
